...
import Tilty from "react-tilty"; // Updated import
  ...
  return (
    ...
    >
      <Tilty
        ...
        scale={1}
        speed={450}
        className='bg-tertiary p-5 rounded-2xl h-full transform transition-transform duration-500 ease-in-out hover:scale-105 hover:bg-gray-900 hover:shadow-2xl'
      >
